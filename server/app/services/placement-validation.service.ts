import { BONUS_MAP, LETTERS_RACK_SIZE, MAX_PLACEMENT_BONUS, MAX_ROW_SIZE } from '@app/classes/constants/constants';
...
import { ScoredWord, UnscoredWord, Word } from '@app/classes/interfaces/word-interfaces';
